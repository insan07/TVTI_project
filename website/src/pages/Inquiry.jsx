          ...
          {!isSubmitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2 text-center pb-2 border-b border-black/5">
                <h1 className="font-heading font-extrabold text-2xl sm:text-3xl text-brand-black uppercase tracking-tight">
                  Online Inquiry
                </h1>
            ...
            <div className="text-center py-8 space-y-6">
              ...
              <div className="space-y-2">
                <h2 className="font-heading font-extrabold text-2xl text-brand-black uppercase tracking-tight">
                  Inquiry Submitted!
                </h2>

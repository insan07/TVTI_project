...
export default function About() {
  return (
    <div className="space-y-6 py-6 sm:py-8 px-5 sm:px-8 lg:px-12 xl:px-16 max-w-7xl mx-auto">
      {/* Intro Section */}
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pt-4 items-center">
          ...
          <div className="bg-brand-charcoal text-brand-white p-8 rounded-xl space-y-4 border border-black/5 shadow-sm">
            <h4 className="font-heading font-bold text-lg text-brand-orange">Our Core Goal</h4>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
        <Card hoverEffect={false}>
          <div className="space-y-3">
            <h3 className="font-heading font-bold text-lg text-brand-black">Our Vision</h3>
        ...
        <Card hoverEffect={false}>
          <div className="space-y-3">
            <h3 className="font-heading font-bold text-lg text-brand-black">Our Mission</h3>
            <p className="text-brand-charcoal/80 text-sm leading-relaxed">
